...
set "MOD_PATH=P:\Mods\@IDFramework"
rmdir /s "%MOD_PATH%"
md "%MOD_PATH%/addons"
...
start /wait /D "%ADDON_BUILDER_PATH%" AddonBuilder.exe "P:\IE\IDFramework" "%MOD_PATH%\addons" -project="P:" -prefix="IE/IDFramework" -clear -binarizeFullLogs -sign="%UserProfile%\Documents\Keys\IstarEldritch.biprivatekey"
