...
start /D "%DAYZ_PATH%" DayZDiag_x64.exe "-mission=%SCRIPT_DIR%\mission\dayzOffline.chernarusplus" "-mod=P:\Mods\@CF;P:\Mods\@Community-Online-Tools;P:\Mods\@IEFramework;P:\Mods\@IDFramework" -server -filePatching "-profiles=%SCRIPT_DIR%\profiles" "-config=%SCRIPT_DIR%\serverDZ.cfg"
